...
public sealed class MathBlocksCUDAProgramPopulation : IDisposable
{
    ...
    private MathBlocksCUDAProgramPopulation(
    ...
    internal static MathBlocksCUDAProgramPopulation Create(MathBlockProgramPopulationDefinition definition)
    {
        ...
        try
        {
            ...
            {
                Function = MathBlockProgramPopulationCudaKernel.Function,
                GridX = 1,
                GridY = 1,
                GridZ = 1,
                BlockX = 1,
            ...
            var state = definition.AcceptedState ?? new MathBlockProgramPopulationState(
                ...
                [],
                []);
            return new MathBlocksCUDAProgramPopulation(
                definition,
                layout,
                arguments,
                deviceArena,
...
internal sealed class PopulationLayout
{
    ...
    public static PopulationLayout Create(MathBlockProgramPopulationDefinition definition)
    {
        ...
        for (var index = 0; index < definition.Grammar.Operations.Count; index++)
        {
            ...
            operationOpcodes[index] = MathBlockProgramPopulationCudaOperations.Resolve(operation.Identity);
    ...
    private static void ValidateOperations(MathBlockProgramPopulationDefinition definition)
    {
        foreach (var descriptor in definition.Grammar.Operations)
        {
            ...
            if (!ContainsIdentity(MathBlocksCUDAWorker.SupportedBlockIdentities, descriptor.Identity))
            ...
            _ = MathBlockProgramPopulationCudaOperations.Resolve(descriptor.Identity);
        }
    }
...
internal static class MathBlockProgramPopulationCudaOperations
{
